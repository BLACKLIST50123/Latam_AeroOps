...
public class Copia_Login_GUI extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Copia_Login_GUI.class.getName());

    public Copia_Login_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Copia_Login_GUI().setVisible(true));
    }
