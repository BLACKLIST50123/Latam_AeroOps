...
public class Copia_OficialOperaciones_GUI extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Copia_OficialOperaciones_GUI.class.getName());


    public Copia_OficialOperaciones_GUI() {
        initComponents();
...
// BORRAR ESTO LUEGO Y SU METODOD## INYECCION DE DATOS DE PRUEBA ##
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Copia_OficialOperaciones_GUI().setVisible(true));
    }
